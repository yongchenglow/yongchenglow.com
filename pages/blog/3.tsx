        ...
        <Box py={3}>
          ...
          <Box maxWidth="md" mx="auto">
            <Typography
              ...
              marginBottom={3}
            >
              You just learned about scrum and feel confident to start your
              Sprint Planning session. However, what exactly does Sprint
              Planning consist of? How do we decide what features are going to
              be built in the current sprint? What are the outcomes of a Sprint
              Planning session?
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              like us to take a step back and look at the big picture. Instead
              of focusing on one sprint, lets focus on the product that we are
              building first. This is so that we know what we are working
              towards after the completion of multiple sprints.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={7}
            >
              Every product that a company build is paid for by a particular
              user. Therefore, before doing any planning, we first need to
              revisit who our users are. This is because if we start deviating
              from their needs and wants, they will eventually look for a close
              substitute.
            </Typography>
            <Typography
              variant="h4"
            ...
            >
              ...
              audience. Some companies grow so big that they do not see the need
              for Personas.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              story moments with a certain network. When TikTok emerged, those
              who use Instagram to create content or skits flocked over as they
              are their targeted user groups. Only by understanding this, you
              realize that Instagram and TikTok are not really true competitors
              as they target a different set of audience. However, because
              TikTok did not exist before 2016, these creators did not have a
              choice but to use Instagram.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={7}
            ...
            <Typography
              ...
              marginBottom={3}
            >
              Whenever the team wants to build something special, you will need
              to draw out some kind of game plan. One of the most popular ways
              to organize your work is through initiatives, epics, stories,
              task, sub-task. This is a very user centric approach as each task
            ...
            <Box my={3} maxWidth="sm" mx="auto">
              ...
              >
                ...
                can do with your product after it is completed
              </Typography>
              <Typography
                fontSize={theme.typography.h6.fontSize}
                textAlign="center"
            ...
            >
              ...
              up, Notion, Asana and Monday. All the different products have
              their own advantages and limitations which we will not discuss.
              However, from my personal experience, it is better for a company
              or team stick to a single tool, meaning to say if one team uses
              Jira, the rest should use it too. Or else managing scaled up scrum
              where one team is using notion and another is using Jira will turn
              into a nightmare.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              <ol>
                ...
                <li>
                  Write the necessary integration test to ensure that the
                  feature work
                </li>
            ...
            >
              ...
              backlog that the team will be working on and sets the initial
              sprint goal. These items are usually picked because they are
              related to the initiative and epics of the previous sprint or
              because are starting a new one.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={3}
            >
              ...
              scoping and specifications needed to deliver the sprint goal. It
              is important that this process is a negotiation, if the work is
              too much, we need to adjust the what. But at the end of the day,
              the scope of work must be manageable and the team must agree that
              the items pick can meet the definition of done by the end of the
              sprint.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              the team then decides <b>the who</b>, in other words who takes
              which task. This process is done purely by the development team.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={3}
            ...
            >
              ...
              during the maintenance stage, the original developers usually
              leave the company. The company then hires new people to maintain
              the product. If you go to Google and just type coding memes, you
              may laugh at first, but those are actually true stories no matter
              how fake they seem. Once the people are tired of pulling their
              hair out to solve problems they leave and the process starts all
              over again.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
