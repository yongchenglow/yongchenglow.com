        ...
        <Box py={3}>
          ...
          <Box maxWidth="md" mx="auto">
            ...
            >
              ...
              you think is the first thing they do? Do they start by writing
              code? Don’t think so? Then how do you think a typical development
              team work? What rituals should a team follow so that they can
              deliver a high-quality piece of software at record breaking time.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={3}
            ...
            <Typography
              ...
              marginBottom={3}
            >
              Now, before we go on any further, I would first like to manage
              your expectations. What I am about to describe to you is my own
              interpretation and what I find works best for the teams that I
              have worked for. By no means you should quote me or tell your
              employers this should be the way things are done. Instead, you
              should be using this article to understand the different concepts
              and how they work. It is also important to understand that each
              team works a bit differently. Hence, they should adjust the Scrum
              framework to utilize the strength of all of their team members.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={7}
            ...
            >
              ...
              many cross-functional members responsible for the development of
              the product. It is important to note that the development team
              does not only contain software engineers, but whoever is needed to
              complete the task at hand. Although this means that members can
              easily come and go, it is important to consider the loss in
              working velocity when onboarding a new member, or when losing
            ...
            <Typography
              ...
              marginBottom={3}
            >
              Some of the more common roles that you may see in a Development
              Team includes:
              <ul>
            ...
            <Typography
              ...
              marginBottom={5}
            >
              *E.g. A 4 week sprint should have a maximum of 2x4=8 hours of
              Sprint Planning
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              and select items to be placed in the Sprint Goal that they commit
              to completed by the end of the sprint. This is also where the
            ...
            <Typography
              ...
              marginBottom={3}
            >
              The <b>Daily Scrum</b> is a meeting to monitor the progress of
              work and identify any blockers. Each person has to answer 3
            ...
            >
              ...
              reflect on how they work over the past sprint. The 3 questions
              that the team have to answer are:
              <ol>
            ...
            <Typography
              ...
              marginBottom={3}
            >
              There are some companies that add additional rituals to ensure
              that the team can work at a stable velocity. These include:
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={3}
            >
              ...
              sprint. This is to check if there are any risk of not being able
              to meet the sprint goal. If there are any, make the necessary
              adjustments.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              full of technical engineers. This session is basically taken out
              of the Sprint Planning time to align on the technical
              specifications such as the database design, Api request and
              response, frontend and backend validations etc. This ensures that
              the tech team is all on the same page so that frontend and backend
              can be built concurrently. Those that are not involved in the Tech
              Bounce will be doing their own version of Tech bounce, e.g.
              Designers, UX researchers will align on the Discovery Task and
              Hypothesis, QA may be planning out on what they need to do to
              strengthen the automation testing.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={7}
            ...
            >
              ...
              workplace, everyone is usually working at their own pace,
              therefore the rituals serves as a common timing for us to check in
              on each other. In a physical workplace, especially if your team
              sits in the same room and constantly talks to each other, rituals
              such as the Daily Scrum may become ineffective.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={3}
            ...
            <Typography
              ...
              marginBottom={3}
            >
              So if your company decides how you work, how will this article
              help you? In my opinion, if you are given a take home assignment,
              joining a hackathon, or starting a new side project, the scrum
              framework is something that you should modify off to delivery
              software. How do you apply scrum in your projects? Well,
              unfortunately you will have to read the next few articles to find
              out.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={7}
            >
              In conclusion, I have scraped the surface of what is Scrum, what
              the teams are made up of and the different rituals that a team
              will follow. The next few articles will be focused around Sprint
