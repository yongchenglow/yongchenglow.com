        ...
        <Box py={3}>
          ...
          <Box maxWidth="md" mx="auto">
            ...
            >
              ...
              application. How our website looks, feel and functions also plays
              a major factor in user retention.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={3}
            >
              ...
              , the design system between the Mac, iPad, and iPhone share the
              same design language making their users feel comfortable as they
              switch between these products.
            </Typography>
            <Typography
              fontSize={theme.typography.h6.fontSize}
              marginBottom={7}
            >
              ...
              designed and a basic matrix on how we can evaluate a user
              interface. This will help you understand the different
              terminologies, the process and the standards that is being used in
              the industry. This will allow engineers and designers to work
              together to create a better product. We will leave the creation of
              design system and other higher level items for another day.
            </Typography>
            <Typography
              variant="h4"
              fontWeight={500}
            ...
            >
              ...
              definition which we will used that I learned from my time at{' '}
            ...
            >
              ...
              that comes up with a super elegant and fancy user interface in 10
              days and in return takes 5 senior engineers 3 months to create.
              However, according to our definition, this can be a bad design
              because a company might not have the resources to afford the
              designers 10 days to create it and pay 3 senior engineers for 3
            ...
            <Box my={3} maxWidth="sm" mx="auto">
              ...
              >
                ...
                is a human-centred, collaborative problem-solving approach that
                is creative, iterative and practical.
              </Typography>
            </Box>
            <Typography
              fontSize={theme.typography.h6.fontSize}
            ...
            >
              ...
              is broken down into smaller sub task then the scoring metrics will
              be a bit different. It is important to note that once a unit of
              measurement is chosen, it shall remain constant so that in the
              next iteration we can compare the results to see if the design had
