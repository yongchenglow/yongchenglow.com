    ...
    <StandardLayout>
      <Box py={3} textAlign="center">
        ...
        <Box maxWidth={theme.spacing(80)} mx="auto" mb={2}>
          For now, this section of the page is still under construction. If you
          want to find out more about me, please proceed to my LinkedIn
        </Box>
        <MuiLink
          href="https://www.linkedin.com/in/yong-cheng-low/"
          target="_blank"
        >
          <LinkedInIcon sx={{ color: '#0072B1', fontSize: theme.spacing(8) }} />
        </MuiLink>
      </Box>
    </StandardLayout>
  );
