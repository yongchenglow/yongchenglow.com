  ...
  return (
    <StandardLayout>
      <Box textAlign="center" mt={2}>
        ...
        />
        <Box mt={1}>
          <Typography variant="h4">Hello and welcome to my webpage!</Typography>
        </Box>
      </Box>
      ...
      <Box py={3} textAlign="center">
        ...
        <Box maxWidth={theme.spacing(80)} mx="auto">
          I am Yong Cheng, sometimes my friends call me YC for short. I am a Web
          Software Engineer currently working at Glints and I teach at Le Wagon
          Singapore part time. Check out some of my articles that I write as I
          try to share with others about my software engineering journey. You
          can find out more about me at my about page.
        </Box>
      </Box>
    </StandardLayout>
  );
