...
git push origin main`}
					...
					<ArticleSection title="Setting up VS Code">
						...
						<ArticleParagraph>
							...
							formatter standardization, this makes the project look as if it
						...
						<ArticleParagraph>
							...
							color when you type them in a js file. Reserved words should also
							be in a different color to prevent weird variable naming errors.
