...
The **Scrum master** is responsible to facilitate, advocate and coach the teams to ensure that the scrum teams are adhering to the scrum rules and are working at a sustainable pace.
...
**Sprint Review** is where the increment created from the sprint is showcased to the stakeholders. Stakeholders can inspect the work and raise questions or concerns or raise adjustments.
