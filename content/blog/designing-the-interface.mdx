...
**Design** is solving problems given a set of constraints
...
What this definition of design means is that a good design takes into consideration not only the users, but also the resources available. This includes time, cost, and technology. A designer may come up with a super elegant and fancy user interface in 10 days, but if it takes 5 senior engineers 3 months to build, that can be a bad design — a company might not have the resources to afford it. A good designer takes into consideration constraints such as time, cost, and manpower before creating the final design.
