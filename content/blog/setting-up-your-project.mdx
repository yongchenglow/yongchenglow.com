...
If you want to follow along this project setup series, please setup your computer according to the [Le Wagon setup instructions](https://github.com/lewagon/setup). The setup instructions are courtesy of [Le Wagon](https://www.lewagon.com), I do teach there part time. If you are interested in their courses feel free to sign up. They have offices everywhere world wide.
