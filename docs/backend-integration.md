...
| Route | Data source |
| --- | --- |
| `/blog` | Featured post and a four-post grid selected from positions two through five in date order |
...
sequenceDiagram
    ...
    Browser->>Browser: Merge duplicate posts found across fields
```
